...
import { ArrowLeft, Building, MapPin, Phone, FileText } from "lucide-react"
...
export default function NewSupplierPage() {
  ...
  const categories = ["Technology", "Office Supplies", "Services", "Marketing", "Equipment", "Utilities", "Other"]
        ...
        <div className="flex flex-1 flex-col gap-6 p-4 pt-0 max-w-none">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Create a new supplier profile for your business</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Supplier Preview</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-medium">{formData.name || "Company Name"}</h3>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>{formData.cnpj || "Not provided"}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
